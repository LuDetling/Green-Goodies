 ...
 */
final class Version20241108140307 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE order_product ADD id INT AUTO_INCREMENT NOT NULL, ADD order_id_id INT DEFAULT NULL, ADD product_id_id INT DEFAULT NULL, ADD quantity INT NOT NULL, DROP order_id, DROP product_id, DROP PRIMARY KEY, ADD PRIMARY KEY (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE order_product ADD product_id INT NOT NULL, DROP id, DROP order_id_id, DROP product_id_id, CHANGE quantity order_id INT NOT NULL');
